...
- [Zoom Search](https://github.com/goofrey/zoom-search): Python library for agentic search and evidence-grounded RAG workflows with query refinement, source-domain zoom-in, deduplication, streaming outputs, and answer-with-sources synthesis.
